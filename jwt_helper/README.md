# JWT Parser
create a parser that will automatically download JWT signature keys and use it to verify jwt input
example usage
```go
package main
...
import (
	...
	"github.com/the-goat-jp/yabai-mono-service/module/user/pkg/helper"
)
